/**
 * ProfileGlobal component displays the user's profile information, including banner, avatar, name, and bio.
 * Allows the user to edit their profile via a modal form and shows success messages using a Snackbar.
 *
 * @component
 * @returns {JSX.Element} The rendered ProfileGlobal component.
 */
    ...
    <div>
      <div className={profileStyles.bannerAvatarDiv}>
        ...
        <img
          ...
          src={userProfile.avatar?.url || DefaultImage}
          alt="avatar"
        />
      </div>
