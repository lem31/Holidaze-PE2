  ...
  return (
    <div>
        ...
        <header className={hStyles.header}>
          ...
          <nav className={hStyles.nav}>
            <div className={hStyles.navDiv}>
              ...
              {!isLoggedIn && (
                <>
                  <a className={hStyles.navLink} href="/Register">
                    <img
                      className={hStyles.navIcons}
                      src={Register}
                      alt="Register Icon"
                  ...
                  <a className={hStyles.navLink} href="/Login">
                    {" "}
                    <img
                      className={hStyles.navIcons}
                      src={Login}
              ...
              <div className={hStyles.accountBox}>
                ...
                >
                  <img
                    className={hStyles.navIcons}
                    src={Account}
                    alt="Account Dropdown Options Icon"
                  />
                </button>
              </div>
            </div>
      ...
      <div className={hStyles.dropDownBoxContainer}>
        {isDropDownOpen && <UserDropDown isOpen={isDropDownOpen} />}
      </div>
    </div>
  );
}
